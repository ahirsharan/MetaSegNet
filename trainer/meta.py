...
class MetaTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.model.load_state_dict(torch.load(osp.join(self.args.save_path, 'epoch20' + '.pth'))['params'])
        self.optimizer.load_state_dict(torch.load(osp.join(self.args.save_path, 'epoch20' + '_o.pth'))['params_o'])
        self.lr_scheduler.load_state_dict(torch.load(osp.join(self.args.save_path, 'epoch20' + '_s.pth'))['params_s'])
