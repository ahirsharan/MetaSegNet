...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='PASCAL', choices=['COCO','PASCAL']) # Dataset
    parser.add_argument('--maxclass', type=int, default=21, choices=[10,21]) # Total classes in Datatset ; 21 for PASCAL and 10 for COCO
